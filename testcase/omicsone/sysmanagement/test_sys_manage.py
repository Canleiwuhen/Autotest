...
class TestSys:
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.feature("系统管理-设备管理")
    @allure.title("系统管理-设备管理-查询")
    def test_search_device(self, res):
        search_data = {}
        # 查询测序设备
        search_sequence_res = res.post_request("/api/base/device/sequence/list", json=search_data)
        assert search_sequence_res.status_code == 200
        assert search_sequence_res.json()['retInfo'] == 'success'
        search_ipipette_res = res.post_request("/api/base/device/ipipette/instrument/list", json=search_data)
        assert search_ipipette_res.status_code == 200
        assert search_ipipette_res.json()['retInfo'] == 'success'
    ...
    # @allure.severity(allure.severity_level.CRITICAL)
    # @allure.feature("系统管理-运维管理")
    # @allure.title("系统管理-运维管理-检测项目设置-设置保存")
    # def test_save_config(self, res):
    #     save_data = {"configItems": [{"configItemId": "3", "value": "1"}, {"configItemId": "4", "value": "enrich"},
    #                                  {"configItemId": "5", "value": "1"}, {"configItemId": "6", "value": "1"},
    #                                  {"configItemId": "7", "value": "1"}, {"configItemId": "8", "value": "1"},
    #                                  {"configItemId": "9", "value": "0"}, {"configItemId": "10", "value": 1},
    #                                  {"configItemId": "11", "value": "1"}, {"configItemId": "12", "value": "1"},
    #                                  {"configItemId": "15",
    #                                   "value": "Pretreatment,LibraryPrep,Hybridization,SequencingPrep"},
    #                                  {"configItemId": "16", "value": "Hybridization"}, {"configItemId": "17",
    #                                                                                     "value": "Pretreatment,LibraryPrep,Hybridization,SequencingPrep"},
    #                                  {"configItemId": "18", "value": "0"},
    #                                  {"configItemId": "21", "value": "Pretreatment,LibraryPrep,SequencingPrep"},
    #                                  {"configItemId": "22", "value": "Pretreatment,LibraryPrep,SequencingPrep"},
    #                                  {"configItemId": "23", "value": "1"}, {"configItemId": "24", "value": "enrich"},
    #                                  {"configItemId": "25", "value": "1"}, {"configItemId": "26", "value": "0"}]}
    #     save_data_res = res.post_request("/api/base/configItem/update", json=save_data)
